    ...
    <div class="address">
      ...
      <div class="info" v-if="addressList">
        ...
        <div class="info-address">
          {{selectAddress.region.province + selectAddress.region.city + selectAddress.region.region + this.selectAddress.detail}}
        </div>
      </div>
...
<script>
import { getDefaultId } from '@/utils/storage'
...
export default {
  ...
  computed: {
    ...mapState('address', ['defaultId']),
    selectAddress () {
      return this.addressList.find(item => item.address_id === this.preDefaultId) || this.addressList.find(item => item.address_id === this.defaultId)
    },
    mode () {
  ...
  methods: {
    ...
    // const res = await orderCommentList(item.order_id)
    // console.log(res)
    // })
    //   this.list = list.data
